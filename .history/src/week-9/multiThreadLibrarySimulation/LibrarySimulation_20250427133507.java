...
*/
Sets up the library and books,creates user threads,starts them,and waits for each to finish using join().Finally,it displays the remaining available books.
