...
public class EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        List<Employee> employees = List.of(
                ...
                List<String> upperCaseNames = transformEmployeeNames(employees);
                ...
                Map<String, List<Employee>> groupedBySalaryRange = groupEmployeesBySalaryRange(employees);
            ...
            public static List<String> transformEmployeeNames(List<Employee> employees) {
                return employees.stream().map(e -> e.getName().toUpperCase()).collect(Collectors.toList());
            }
            
            // Method to group employees by salary range
            public static Map<String, List<Employee>> groupEmployeesBySalaryRange(List<Employee> employees) {
